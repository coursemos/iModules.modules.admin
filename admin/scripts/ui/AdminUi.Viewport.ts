...
namespace AdminUi {
    export namespace Viewport {
        export class Panel extends Aui.Component {
            ...
            navigation: AdminUi.Viewport.Navigation.Panel;
        ...
        export namespace Navigation {
            export class Panel extends Aui.Panel {
                ...
                contexts: AdminUi.Viewport.Navigation.Context[] = [];
                sorter: AdminUi.Viewport.Navigation.Sorter;
                 ...
                 */
                getViewport(): AdminUi.Viewport.Panel {
                    return this.getParent() as AdminUi.Viewport.Panel;
                }
            ...
            export class Context extends Aui.Component {
                ...
                target: string;
                contextType: string;
                children: AdminUi.Viewport.Navigation.Context[] = [];
            ...
            export class Sorter {
                panel: AdminUi.Viewport.Navigation.Panel;
                context: AdminUi.Viewport.Navigation.Context = null;
                $context: Dom = null;
                $drag: Dom = null;
                $drop: Dom = null;
                tops: number[] = [];
                 ...
                 */
                constructor(panel: AdminUi.Viewport.Navigation.Panel) {
                    this.panel = panel;
                    this.setEvent();
                }
                ...
                $setDrag($target: Dom): Dom {
                    ...
                    this.context = Aui.get($target.getData('component')) as AdminUi.Viewport.Navigation.Context;
                ...
                setDropPosition(y: number): void {
                    ...
                    if (dropIndex[1] == null) {
                        ...
                        Html.get('div[data-role=bottom]', this.$contexts[dropIndex[0]]).append(
                            this.$drop,
                            dropIndex[1]
                        );
                    }
