...
Admin.ready(async () => {
    ...
    return new Aui.Panel({
            ...
            new Aui.Tree.Panel({
                ...
                listeners: {
                    ...
                    selectionChange: (selections) => {
                        const context = Aui.getComponent('database-context');
                        const table = Aui.getComponent('table');
                        table.removeAll();
                        if (selections.length == 1) {
                            ...
                            if (name == '@') {
                                ...
                                table.append(new Aui.Grid.Panel({
                                    layout: 'fit',
                                    border: false,
                                    topbar: [
                                        new Aui.Form.Field.Search({
                                    ...
                                    listeners: {
                                        openMenu: (menu, record, _rowIndex, grid) => {
                                            ...
                                            menu.add({
                                                ...
                                                handler: async () => {
                                                    const tree = Aui.getComponent('tables');
                                        ...
                                        openMenus: (menu, selections, grid) => {
                                            menu.setTitle(Aui.printText('texts.selected', {
                                ...
                                table.append(new Aui.Tab.Panel({
                                    id: name,
                                    border: false,
                                    layout: 'fit',
                                    tabPosition: 'bottom',
        ...
        setUrl: () => {
            ...
            if (name !== '@') {
                const table = Aui.getComponent(name);
