    ...
    export namespace Viewport {
        ...
        export namespace Navigation {
            ...
            export class Context extends Admin.Component {
                ...
                target: string;
                contextType: string;
                children: Admin.Viewport.Navigation.Context[] = [];
            ...
            export class Sorter {
                panel: Admin.Viewport.Navigation.Panel;
                context: Admin.Viewport.Navigation.Context = null;
                $context: Dom = null;
                $drag: Dom = null;
                $drop: Dom = null;
                tops: number[] = [];
                 ...
                 */
                constructor(panel: Admin.Viewport.Navigation.Panel) {
                    this.panel = panel;
                    this.setEvent();
                }
                ...
                $setDrag($target: Dom): Dom {
                    ...
                    this.context = Admin.get($target.getData('component')) as Admin.Viewport.Navigation.Context;
