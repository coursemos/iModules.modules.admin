...
var Admin;
(function (Admin) {
    class TreeStore extends Admin.Base {
        primaryKeys;
        fields;
        childrenField;
        params;
    ...
    Admin.TreeStore = TreeStore;
    (function (TreeStore) {
        class Array extends Admin.TreeStore {
            records;
            /**
             * Array 스토어를 생성한다.
             *
        ...
        class Ajax extends Admin.TreeStore {
            method;
            url;
            recordsField;
            totalField;
            ...
            async load() {
                ...
                if (results.success == true) {
                    this.loaded = true;
                    this.data = new Admin.TreeData(results[this.recordsField] ?? [], this.fields, this.primaryKeys, this.childrenField);
        ...
        TreeStore.Ajax = Ajax;
    })(TreeStore = Admin.TreeStore || (Admin.TreeStore = {}));
})(Admin || (Admin = {}));
